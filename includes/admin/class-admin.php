        ...
        jQuery(document).ready(function($) {
            ...
            function performInitialSync() {
                $.ajax({
                    ...
                    error: function() {
                        $('#sync-result').html('<div class="notice notice-error inline"><p>Synchronization failed - please try again</p></div>');
                        resetSyncButton($('#synchronize-btn'));
                    }
                });
            }
                    ...
                    success: function(response) {
                        ...
                        if (response.success) {
                            ...
                            if (data.has_more && !terminateSync) {
                                ...
                                // Sync complete - show final page message briefly before completion
                                setTimeout(function() {
